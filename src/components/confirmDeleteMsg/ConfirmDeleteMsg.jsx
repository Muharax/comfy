...
const ConfirmDeleteMsg = () => {
    ...
    return (
        <div className='confirm-delete-msg'>
            <Modal show={showConfirmDelete} onHide={handleCloseConfirmDelete} animation={false} aria-labelledby="contained-modal-title-vcenter"
                centered backdrop="static" className='confirm-delete-msg-modal'>
