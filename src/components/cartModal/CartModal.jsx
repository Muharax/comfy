    ...
    return (
        <div className='cart-modal'>
            <div className="cart-modal-box">
                <Modal show={setShowCartModal} onHide={handleCloseShowCartModal} className='cart-modal-Modal' backdrop="static">
                        ...
                        {cart.length ?
                            <>
                                ...
                                <div className="cart-box-footer">
                                    ...
                                    <Link to="/checkout/information" onClick={() => setShowCartModal(false)} className='checkout'>Checkout</Link>
                                    <Link to="/viewCart" onClick={() => setShowCartModal(false)}>View cart</Link>
                                </div>
                                {/* cart box footer end */}
                            </>
                            :
                            <>
                                <div className='cart-is-empty'>
                                    ...
                                    <Link to="/shop" onClick={() => setShowCartModal(false)}>Return to Shop</Link>
                                </div>
                            </>
                        }
                    </Modal.Body>
