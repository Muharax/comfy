...
let percentage2 = (price - min) * 100 / (max - min);

const sliderStyle2 = {
    // make the background size daynamic based on input value
    backgroundSize: percentage2 + '%'
};
  ...
  return (
    ...
    <>
      ...
      <div className="shop-sidebar-small">
        ...
        <Modal show={showSmallSideBar} onHide={handleCloseShowSmallSideBar} className='small-sidebar-modal' backdrop="static">
